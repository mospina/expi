          ...
          context = %Context{
            messages: [
              %UserMessage{
                role: :user,
                content:
                  "Solve this step by step: If a train leaves Station A at 2 PM traveling at 60 mph, and another train leaves Station B at 3 PM traveling at 80 mph toward Station A, and the stations are 280 miles apart, when do they meet?",
                timestamp: System.system_time(:millisecond)
              }
            ]
          }
