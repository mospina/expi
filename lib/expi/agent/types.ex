defmodule Expi.Agent.Types do
  ...
  defmodule AgentEvent do
    ...
    @type event_type :: :agent_start | :agent_end |
                        :turn_start | :turn_end |
    ...
    defstruct [
      :type, :messages, :message, :tool_results, :assistant_message_event,
      :tool_call_id, :tool_name, :args, :partial_result, :result, :is_error
    ]
